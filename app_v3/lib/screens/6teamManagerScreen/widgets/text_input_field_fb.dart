...
class CustomTextInputFieldFb extends StatefulWidget {
  ...
  @override
  State<CustomTextInputFieldFb> createState() => _CustomTextInputFieldFbState();
}

class _CustomTextInputFieldFbState extends State<CustomTextInputFieldFb> {
  @override
          ...
          Flexible(
            ...
            child: TextFormField(
                ...
                onFieldSubmitted: (value) {
                  setState(() {
                    teamsData.updateFbUsername(widget.id, value);
                  });
                }),
          ),
