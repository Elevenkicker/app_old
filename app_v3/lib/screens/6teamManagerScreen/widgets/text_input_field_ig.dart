...
class CustomTextInputFieldIg extends StatefulWidget {
  ...
  @override
  State<CustomTextInputFieldIg> createState() => _CustomTextInputFieldIgState();
}

class _CustomTextInputFieldIgState extends State<CustomTextInputFieldIg> {
  @override
          ...
          Flexible(
            ...
            child: TextFormField(
                ...
                onFieldSubmitted: (value) {
                  setState(() {
                    teamsData.updateIgUsername(widget.id, value);
                  });
                }),
          ),
